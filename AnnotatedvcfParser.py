...
analisi ha portato a 
    ...
    if annotator_to_splitTranscripts != "skip" :
        ...
        vcfFileTransplitted = pipe2Col(vcf_file, vcfFileTransplitted, annotator_to_splitTranscripts)
        print("File CSV succesfully generated")
        print("Summary:")
        print("****************************************************************************************")
        #print(vcfFileTransplitted)
        vcfFileTransplitted.info(verbose=True)
        print("********************************************yussab**************************************")
        #test.to_csv("test.csv")
        vcfFileTransplitted.to_csv(output_file_path)
    else:
